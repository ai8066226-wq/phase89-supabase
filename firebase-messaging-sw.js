...
firebase.messaging().onBackgroundMessage(payload=>{const n=payload.notification||{};self.registration.showNotification(n.title||'آمرني',{body:n.body||'لديك تحديث جديد',icon:'./favicon.ico',data:payload.data||{}});});
